    ...
    this.loginservi.traerDatosUsuario().subscribe(
      datos =>{
        ...
        else
        {
          ...
          else if(this.clienteLogeado.pedido == "verificado")
          {
            this.items = [
              {icono : "qr-scanner" , nombre : "Pedir mesa" , ruta : "pedir-mesa-cliente"},
              {icono : "restaurant" , nombre : "Hacer pedido" , ruta : "hacer-pedido-cliente"},
              {icono : "clock" , nombre : "Ver estado del pedido" , ruta : "verificar-estado-pedido"},
              {icono : "logo-game-controller-a" , nombre : "Juegos" , ruta : "juegos-cliente"},
              {icono : "clipboard" , nombre : "Encuesta" , ruta : "encuesta-cliente"},
              {icono : "cash" , nombre : "Pedir la cuenta" , ruta : "pedir-cuenta-cliente"},
            ]
          }
          else
          {
